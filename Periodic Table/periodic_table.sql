...
--
-- Name: elements elements_name_skey; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT elements_name_skey UNIQUE (name);
...
--
-- Name: elements elements_symbol_skey; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT elements_symbol_skey UNIQUE (symbol);
